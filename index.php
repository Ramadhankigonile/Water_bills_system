    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php"><b>Water Billing System</b></a>
            </div>
            <!--/.nav-collapse -->
        </div>
    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 signup">
                        <h1>Water Billing</h1>
                        <p>Water's a valuable resource. If we each take a few simple steps, we can conserve water, save money on our <b>water bills</b> and ensure a healthy future supply.</p>
                    </div>
                    <!-- /col-lg-6 -->
                    <div class="col-lg-6">
                        <h1>Login</h1>
